...
/**
* <p>NotificationService is a static Cover for the {@link org.sakaiproject.event.api.NotificationService NotificationService};
...
public class NotificationService
{
	...
	public static org.sakaiproject.event.api.NotificationService getInstance()
	{
		...
		{
			if (m_instance == null) m_instance = (org.sakaiproject.event.api.NotificationService) ComponentManager.get(org.sakaiproject.event.api.NotificationService.class);
			return m_instance;
		}
		else
		{
			return (org.sakaiproject.event.api.NotificationService) ComponentManager.get(org.sakaiproject.event.api.NotificationService.class);
		}
	}
	...
	public static org.sakaiproject.event.api.Notification getNotification(java.lang.String param0) throws org.sakaiproject.event.api.NotificationNotDefinedException
	{
		org.sakaiproject.event.api.NotificationService service = getInstance();
		if (service == null)
			return null;
	...
	public static org.sakaiproject.event.api.NotificationEdit editNotification(java.lang.String param0) throws org.sakaiproject.event.api.NotificationNotDefinedException, org.sakaiproject.event.api.NotificationLockedException
	{
		org.sakaiproject.event.api.NotificationService service = getInstance();
		if (service == null)
			return null;
