...
public abstract class ClusterEventSqlGeneric implements ClusterEventSql {

	public String returnSelectEvent() {
		String statement = "select EVENT_ID,EVENT_DATE,EVENT,REF,SAKAI_EVENT.SESSION_ID,EVENT_CODE,SESSION_SERVER"
	...
	public String returnSelectMaxEventId() {
